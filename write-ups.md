...
{% for post in site.posts %}
  <a href="{{ site.baseurl }}{{ post.url }}" class="writeup-card-link" data-title="{{ post.title | escape }}" data-tags="{% for tag in post.tags %}{{ tag | escape }} {% endfor %}" data-description="{{ post.tags }}">
